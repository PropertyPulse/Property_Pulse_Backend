...
public class AdminServiceImpl implements AdminService {
    ...
    @Autowired
    public AdminServiceImpl(PasswordEncoder encoder, UserRepository userRepository, JwtService jwtService, AuthenticationService authenticationService, EmailSenderService emailSenderService) {
    ...
    public String addTopManager(RequestAddNewInternalUserDto req) throws UserException {
        ...
        emailSenderService.sendUserPasswordViaEmail(req.getEmail(), req.getPassword());
